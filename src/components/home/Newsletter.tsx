      ...
      <div className='container z-10 relative p-5 md:p-0'>
        <div className='w-full text-black bg-white p-12 space-y-5 md:w-[50%] lg:w-[40%]'>
          <p className='text-xs uppercase font-semibold'>
            Subcribete a nuestro boletin y recibe promociones 
          </p>
          ...
          <form className='flex flex-col gap-5 xl:flex-row'>
            <input type="email" className='border border-slate-200 focus:outline-none
            rounded-full py-3 px-5 w-full text-xs font-medium'
